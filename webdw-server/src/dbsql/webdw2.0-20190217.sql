...
INSERT INTO `department` VALUES ('11', '11', '14');
INSERT INTO `department` VALUES ('22', '22', '22');
INSERT INTO `department` VALUES ('33', '33', '33');
INSERT INTO `department` VALUES ('44', '44', '44');
...
CREATE TABLE `t_datawindow` (
  ...
  `dw_name` varchar(100) NOT NULL COMMENT '数据窗口名称',
  `dw_define` text NOT NULL COMMENT '数据窗口的定义',
  `dw_selectsql` text COMMENT '数据窗口检索的Select语句，带参数@表示',
  `dw_selectsql_args` varchar(100) DEFAULT NULL COMMENT '数据窗口检索参数定义，逗号分隔',
  PRIMARY KEY (`id`)
...
-- ----------------------------
-- Table structure for t_webdw_token_user
-- ----------------------------
DROP TABLE IF EXISTS `t_webdw_token_user`;
CREATE TABLE `t_webdw_token_user` (
  `id` int(11) NOT NULL COMMENT '记录号',
  `token` varchar(50) NOT NULL COMMENT '系统token',
  `username` varchar(50) NOT NULL COMMENT '用户名',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of t_webdw_token_user
-- ----------------------------
INSERT INTO `t_webdw_token_user` VALUES ('1', 'admin', 'admin');

-- ----------------------------
-- Table structure for t_webdw_user_dwoper
-- ----------------------------
DROP TABLE IF EXISTS `t_webdw_user_dwoper`;
CREATE TABLE `t_webdw_user_dwoper` (
  `id` int(11) NOT NULL COMMENT '记录号',
  `username` varchar(50) NOT NULL COMMENT '用户名称',
  `dwoper` varchar(50) NOT NULL COMMENT '数据窗口操作',
  `dataprivilege` varchar(200) DEFAULT NULL COMMENT '数据权限控制',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of t_webdw_user_dwoper
-- ----------------------------
INSERT INTO `t_webdw_user_dwoper` VALUES ('1', 'guest', 'd_products.SetDataObject', '.');
INSERT INTO `t_webdw_user_dwoper` VALUES ('2', 'guest', 'd_products.Retrieve', '.');
INSERT INTO `t_webdw_user_dwoper` VALUES ('3', 'guest', 'd_products.InsertRow', '.');
INSERT INTO `t_webdw_user_dwoper` VALUES ('4', 'guest', 'd_products.DeleteRow', '.');
INSERT INTO `t_webdw_user_dwoper` VALUES ('5', 'guest', 'd_products.Update', '.');
